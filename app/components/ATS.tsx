const ATS = ({
  ...
  return (
    <div
      className={`rounded-2xl shadow-md w-full bg-gradient-to-b ${gradientFrom} to-light-white p-8 flex flex-col gap-4`}
    >
      <div className='flex flex-row gap-4 items-center'>
        <img src={scoreIcon} alt='ATS' className='w-10 h-10' />
